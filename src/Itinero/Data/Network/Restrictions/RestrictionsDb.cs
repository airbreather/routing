...
namespace Itinero.Data.Network.Restrictions
{
    ...
    public class RestrictionsDb
    {
        ...
        public RestrictionsDb(int hashes = DEFAULT_HASHCOUNT)
        {
            ...
            _restrictions = Constants.MemoryArrayFactory.CreateMemoryBackedArray<uint>(DEFAULT_ARRAY_SIZE);
            _index = Constants.MemoryArrayFactory.CreateMemoryBackedArray<uint>(DEFAULT_ARRAY_SIZE);
        }
